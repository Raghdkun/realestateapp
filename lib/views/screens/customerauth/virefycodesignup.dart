...
import 'package:realestateapp/controllers/customerauth/virfeypasswordsignup_controller.dart';
...
class VerfiyCodeSignUpc extends GetView<VerfiyPasswordSignUpControllercImp> {
  const VerfiyCodeSignUpc({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(VerfiyPasswordSignUpControllercImp());
    return Material(
      child: SafeArea(
          child: GetBuilder<VerfiyPasswordSignUpControllercImp>(
