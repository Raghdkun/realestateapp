...
import 'package:realestateapp/controllers/customerauth/forgetpassword/forgetpassword_controller.dart';
...
class ForgetPasswordc extends StatelessWidget {
  const ForgetPasswordc({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(ForgetPasswordControllercImp());
    return Scaffold(
        appBar: AppBar(
        ...
        body: GetBuilder<ForgetPasswordControllercImp>(
