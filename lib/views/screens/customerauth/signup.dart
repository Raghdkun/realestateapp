...
import 'package:realestateapp/controllers/customerauth/signup_controller.dart';
import 'package:realestateapp/core/class/shimmer/handlingdatasignup.dart';
...
class SignUpc extends GetView<SignUpControllercImp> {
  const SignUpc({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(SignUpControllercImp());
    return Material(
      child: SafeArea(child: GetBuilder<SignUpControllercImp>(
        builder: (controller) {
          return HandlingDataShimmerSignUp(
