...
import 'package:realestateapp/data/remote/auth/signup.dart';


abstract class SignUpcController extends GetxController {
  signUp();
  goToSignIn();
}

class SignUpControllercImp extends SignUpcController {
